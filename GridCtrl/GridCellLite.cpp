...
void CGridCell::Reset()
{
    ...
    // m_lfFont;                    // Cell font				// JD commented (made no sense)
...
/*inline*/ DWORD    CGridCell::GetFormat()    const             { return m_nFormat; }
#if 0	// already defined   // JD
inline COLORREF CGridCell::GetTextClr()   const             { return m_crFgClr; }
inline COLORREF CGridCell::GetBackClr()   const             { return m_crBkClr; }
#endif
#if 0
inline const LOGFONT* CGridCell::GetFont()   const          { return &m_lfFont; }
#else
// /*inline*/ LOGFONT* CGridCell::GetFont()   const { return &m_plfFont; }
#endif
inline UINT     CGridCell::GetMargin()       const          { return m_nMargin; }
