...
//
    ...
    {
        GVIS_FOCUSED = 0x0001,
		GVIS_SELECTED = 0x0002,
		GVIS_DROPHILITED = 0x0004,
		GVIS_READONLY = 0x0008,
		GVIS_FIXED = 0x0010,
		GVIS_FIXEDROW = 0x0020,
		GVIS_FIXEDCOL = 0x0040,
		GVIS_MODIFIED = 0x0080
    };
...
//                                  GVIF_FORMAT|GVIF_FONT|GVIF_MARGIN)
    ...
    {
        GVIF_TEXT = LVIF_TEXT,
        GVIF_IMAGE = LVIF_IMAGE,
        GVIF_PARAM = LVIF_PARAM,
        GVIF_STATE = LVIF_STATE,
        GVIF_BKCLR = (GVIF_STATE << 1),
        GVIF_FGCLR = (GVIF_STATE << 2),
        GVIF_FORMAT = (GVIF_STATE << 3),
        GVIF_FONT = (GVIF_STATE << 4),
        GVIF_MARGIN = (GVIF_STATE << 5),
        GVIF_ALL = (GVIF_TEXT | GVIF_IMAGE | GVIF_PARAM | GVIF_STATE | GVIF_BKCLR | GVIF_FGCLR | GVIF_FORMAT|GVIF_FONT|GVIF_MARGIN)
    };
